...
# Research Paper: https://sing.stanford.edu/curis-fellowships/rh/vision-dnn.pdf 
# NOTE: using batch norm instead of their "response-normalization" layers
...
val_data = datasets.ImageFolder("./tiny-imagenet-200/val", transform=transform)
